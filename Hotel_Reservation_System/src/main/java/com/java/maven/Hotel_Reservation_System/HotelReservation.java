...
public class HotelReservation {
	 ...
	 */
	public boolean addHotel(String hotelName, int weekdayRegularRate, int weekendRegularRate,int weekdayReward,int weekendReward, int rating) {

		Hotel hotel = new Hotel(hotelName, weekdayRegularRate, weekendRegularRate,weekdayReward,weekendReward, rating);
		hotelList.add(hotel);
		return true;
	}
	...
	public void findCheapestHotelOne(String startDateRange, String endDateRange) {
		/**
		 * LocalDate class is used to parse the start and end date ranges with
		 * DateTimeFormater class to pass date format
		 */
	...
	public void findBestRatingForRegular(String startDateRange, String endDateRange) {
		...
		if (startCal.getTimeInMillis() < endCal.getTimeInMillis()) {
			...
			hotel.setTotal(BestHotel.get().getWeekdayRegularRate() * noOfWeekdays
					+ hotel.getWeekendRegularRate() * noOfWeekends);
	...
	public void findCheapestHotelRatingForRegular(String startDateRange, String endDateRange) {
		...
		if (startCal.getTimeInMillis() < endCal.getTimeInMillis()) {
			...
			Hotel hotel = new Hotel(); // Hotel Object
			hotel.setHotelName(cheapestHotel.get().getHotelName());
			hotel.setTotal(cheapestHotel.get().getWeekdayRegularRate() * noOfWeekdays
					+ hotel.getWeekendRegularRate() * noOfWeekends);
